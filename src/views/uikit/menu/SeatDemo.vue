...
<template>
    ...
    <div style="display: flex;margin-top:2%; justify-content: space-between;">
        <div style="width: 45%;">
            <h5>Valor Total</h5>
            <InputText id="aa" type="text" v-model="floatValue" />
        </div>
        <div style="width: 45%;">
            <h5>Nota Fiscal</h5>
            <InputText id="aa" type="text" v-model="floatValue" />
    ...
    <div style="display: flex; justify-content: flex-end; margin-top: 5%; ">
        <a style="margin-right: 1%" href="http://localhost:5173/#/uikit/menu"><Button label="Voltar" class="mr-2 mb-2 p-button-warning" /></a>
        <a style="margin-right: 1%" href="http://localhost:5173/#/uikit/menu/payment"> <Button label="Proximo" class="p-button-info mr-2 mb-2" /></a>
